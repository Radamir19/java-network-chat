...
public class SQLService {
    ...
    private static final String URL_CONNECTION_DATABASE = "jdbc:sqlite:C:/Users/radam/Downloads/java-network-chat-main/java-network-chat-main/src/main/java/ru/geekbrains/database/usersDatabase.db";
